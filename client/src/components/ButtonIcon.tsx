...
const ButtonIcon = ({icon, iconColor}: Props) => {
  ...
  switch (icon) {
      ...
      iconComponent = (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path
            ...
            stroke="#3D293F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path fill={iconColor} d="M9 15L12 12M12 12L15 15M12 12V21" stroke="#3D293F" strokeWidth="2" strokeLinecap="round"
    ...
    case 'check':
      iconComponent = (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path fill={iconColor} d="M5 12L10 17L20 7" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      );
      break;
    default:
